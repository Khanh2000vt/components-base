...
export class ModalBox extends React.PureComponent<IProps, IState> {
  static propTypes = {};
  ...
  renderContent = () => {
    ...
    return (
      <Animated.View
        ...
        <View
          style={{
            borderRadius: modalBorderRadius as number,
        ...
        {/* <ModalWrapper
                    borderRadius={modalBorderRadius as number}
                    backgroundColor={
                        modalBackgroundColor || this.theme.modal.background
                    }
                    width={modalWidth}
                    height={modalHeight}
                >
